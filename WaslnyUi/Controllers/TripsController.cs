    ...
    public class TripsController : Controller
    {
        ...
        public ActionResult StartTrip(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                else if (ex.Message.Contains("You Can't Start a Deleted Trip"))
                {
                    ModelState.AddModelError("", "You Can't Start a Deleted Trip.");
                }
                else
                {
                    ModelState.AddModelError("", "An unexpected error occurred: " + ex.Message);
        ...
        public ActionResult EndTrip(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                else if (ex.Message.Contains("You Can't End a Deleted Trip"))
                {
                    ModelState.AddModelError("", "You Can't End a Deleted Trip.");
                }
                else
                {
                    ModelState.AddModelError("", "An unexpected error occurred: " + ex.Message);
